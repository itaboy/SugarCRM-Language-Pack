...
$mod_strings = array (
   ...
   'LBL_PUBLISHED_REPORTS' => '-- Report Pubblicati --' ,
   'LBL_MY_REPORTS' => '-- I miei report Salvati --' ,
   'LBL_TEAM_REPORTS' => '-- I report del mio Gruppo --' ,
   'LBL_REPORT_NO_CHART' => 'Questo rapporto non ha un grafico' ,
   'LBL_MOVE_CHARTS' => '(Clicca su un nome della tabella per muoverti verso un´altra posizione)',
   'LBL_DASHBOARD_PAGE_1' => 'Grafici Home',
